...
class game:
    qp,availablemoves=[],[]
    plane_e,plane_f=[0 for i in range(c.edge**2)],[1 for i in range(c.edge**2)]
    ...
    def draw(self):
        ...
        print()
        for i in range(c.edge):
            print(str(i) + " "+str(self.qp[i*c.edge:i*c.edge+c.edge]))
            
    def newgame(self):
        self.player=c.player1
        self.qp,self.availablemoves=[c.emptp for i in range(c.edge**2)],[i for i in range(c.edge**2)]
        self.lastmove=-1
        self.plane1,self.plane2=deepcopy(self.plane_e),deepcopy(self.plane_e)
